...
- 예제 2번의 바탕화면은 다음과 같습니다.
    ...
    ![https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/8bf4e2ba-1700-4231-a6ed-c18455919928/eg2.png](https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/8bf4e2ba-1700-4231-a6ed-c18455919928/eg2.png)
...
- 예제 3번의 바탕화면은 다음과 같습니다.
    ...
    ![https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/7cc308f7-b8d7-482e-9e06-18bc1133aea0/eg3.png](https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/7cc308f7-b8d7-482e-9e06-18bc1133aea0/eg3.png)
...
- 예제 4번의 바탕화면은 다음과 같이 2행 1열에만 아이콘이 있습니다.
    ...
    ![https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/5f726562-04dd-4056-8dd7-e58d1519f6ec/eg4.png](https://grepp-programmers.s3.ap-northeast-2.amazonaws.com/files/production/5f726562-04dd-4056-8dd7-e58d1519f6ec/eg4.png)
    ...
    for i in range(H):
        for j in range(W):
            if wallpaper[i][j]=='#':
                ...
                max_h=max(max_h,i)
                max_w=max(max_w,j)
    answer=[min_h,min_w,max_h+1,max_w+1]
    return answer
```

- 파일이 존재하는 좌표 중 최대, 최소값만 찾으면 해결할 수 있다.
- 이 때 최대 좌표에 대해서는 +1씩 더해준다.
...
- 그냥 파일이 존재하는 모든 좌표를 넣고 나중에 한꺼번에 min, max를 해주면 더 간단하다.